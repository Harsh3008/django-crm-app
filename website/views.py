...
def register_user(request):
    if request.method == 'POST':
        ...
        form = SignUpForm()
        return render(request, 'register.html', {'form':form}) # will pass the form into the webpage
...
def customer_record(request,pk):
    if request.user.is_authenticated:
        #Look Up Records
        customer_record = Record.objects.get(id=pk) #to get a single object and then assign it to a variable
